        ...
        <div className="about-page-container">
            ...
            <div className="about-page-info-container">
                ...
                <div className="about-page-text black-text font-inria-serif-light">
                    <p>
                        Deborah Fanara is an artist with a story as diverse as her creations. Beginning her journey as
                        an
                        art
                        major, she immersed herself in pottery and painting before life led her to a degree in
                        occupational
                    ...
                    {/*<p>*/}
                    {/*    Returning to her brushes with fervor, Deborah's daily dedication has birthed a revival. Focusing*/}
                    {/*    on*/}
                    {/*    still life, she intricately captures the essence of everyday objects, each stroke breathing life*/}
                    {/*    into*/}
                    {/*    her canvases. Engaging in art challenges on social media, her work finds a community of admirers*/}
                    {/*    and*/}
                    {/*    fellow creators.*/}
                    {/*</p>*/}
                    {/*<p>*/}
                    ...
                    {/*    journey*/}
                    {/*    from occupational therapy back to the canvas inspires others to pursue their passions, reminding*/}
                    {/*    us*/}
                    {/*    that*/}
